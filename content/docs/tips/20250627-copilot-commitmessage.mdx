---
title: GitHub Copilot のコミットメッセージ生成をカスタムする
date: 2025-06-27
...
私は今まで知らなかったのですが、[Conventional Commits](https://www.conventionalcommits.org/)はコミットメッセージのための軽量の規約でらしいです。
...
[先ほどのコミットメッセージ](#### 実際に生成されるコミットメッセージの例)よりも`<doc>`などをしっかりとかりと記述することで、より正確なコミットメッセージを生成することができます。
